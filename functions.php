...
function wl_scripts() {
	...
	wp_register_script( 'video', 'http://vjs.zencdn.net/5.9.2/video.js', false, '5.9.2', true );
...
function wl_styles() {
	...
	wp_register_style( 'video', 'http://vjs.zencdn.net/5.9.2/video-js.css', false, '5.9.2' );
